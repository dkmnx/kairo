...
- Block non-canonical IP encodings (`127.1`, `2130706433`, `0x7f000001`, octal forms, trailing-dot hosts) and hostnames resolving to private/link-local addresses in base-URL validation
...
- SHA256 fallback for provider catalog verification when cosign is absent
...
- Resolve named provider when `--harness` flag is set
- Allow brackets in model names
...
[2.3.3]: https://github.com/dkmnx/kairo/compare/v2.3.2...v2.3.3
[2.3.2]: https://github.com/dkmnx/kairo/compare/v2.3.1...v2.3.2
[2.3.1]: https://github.com/dkmnx/kairo/compare/v2.3.0...v2.3.1
[2.3.0]: https://github.com/dkmnx/kairo/compare/v2.2.1...v2.3.0
